...
*out = new(apiappsv1.PodManagementPolicyType)
**out = **in
}
if in.Roles != nil {
...
if in.Services != nil {
in, out := &in.Services, &out.Services
*out = make([]appsv1.ComponentService, len(*in))
for i := range *in {
(*in)[i].DeepCopyInto(&(*out)[i])
}
}
...
in.PasswordConfig.DeepCopyInto(&out.PasswordConfig)
if in.Accounts != nil {
