...
func (in *ClusterSpec) DeepCopyInto(out *ClusterSpec) {
	*out = *in
	...
	if in.Services != nil {
		in, out := &in.Services, &out.Services
		*out = make([]v1.ClusterService, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ComponentSpec) DeepCopyInto(out *ComponentSpec) {
	*out = *in
	...
	if in.Services != nil {
		in, out := &in.Services, &out.Services
		*out = make([]v1.ComponentService, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LastComponentConfiguration) DeepCopyInto(out *LastComponentConfiguration) {
	*out = *in
	...
	if in.Services != nil {
		in, out := &in.Services, &out.Services
		*out = make([]v1.ClusterComponentService, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Instances != nil {
		in, out := &in.Instances, &out.Instances
		*out = make([]v1.InstanceTemplate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
